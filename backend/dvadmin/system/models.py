...
class Employee(models.Model):
    ...
    employee_number = models.CharField(max_length=20, null=True, blank=True, verbose_name="员工编号",
                                       help_text="员工编号")
    ...
    card_expire = models.CharField(max_length=10, null=True, blank=True, verbose_name="身份证到期",
                                   help_text="身份证到期")
    ...
    formal_preparation = models.CharField(max_length=1, null=True, blank=True, verbose_name="是否正编",
                                          help_text="是否正编")
    specialized = models.CharField(max_length=20, null=True, blank=True, verbose_name="专业", help_text="专业")
    graduation_date = models.CharField(max_length=10, null=True, blank=True, verbose_name="毕业时间",
                                       help_text="毕业时间")
    social_security = models.CharField(max_length=10, null=True, blank=True, verbose_name="社保缴纳地",
                                       help_text="社保缴纳地")
    contract_expire = models.CharField(max_length=10, null=True, blank=True, verbose_name="合同到期",
                                       help_text="合同到期")
    certificate_name = models.CharField(max_length=100, null=True, blank=True, verbose_name="证书名称",
                                        help_text="证书名称")
    ...
    certification_body = models.CharField(max_length=100, null=True, blank=True, verbose_name="认证机构",
                                          help_text="认证机构")
