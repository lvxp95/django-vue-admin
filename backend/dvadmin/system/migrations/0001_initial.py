    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_number', models.CharField(blank=True, help_text='员工编号', max_length=20, null=True, verbose_name='员工编号')),
                ('gender', models.CharField(blank=True, help_text='性别', max_length=1, null=True, verbose_name='性别')),
                ('card_number', models.CharField(blank=True, help_text='身份证号', max_length=18, null=True, verbose_name='身份证号')),
                ('card_expire', models.CharField(blank=True, help_text='身份证到期', max_length=10, null=True, verbose_name='身份证到期')),
                ('degree', models.CharField(help_text='学历', max_length=5, verbose_name='学历')),
                ('phone', models.CharField(blank=True, help_text='电话', max_length=11, null=True, verbose_name='电话')),
                ('formal_preparation', models.CharField(blank=True, help_text='是否正编', max_length=1, null=True, verbose_name='是否正编')),
                ('specialized', models.CharField(help_text='专业', max_length=20, verbose_name='专业')),
                ('graduation_date', models.CharField(default='2010/12/30', help_text='毕业时间', max_length=10, verbose_name='毕业时间')),
                ('social_security', models.CharField(blank=True, help_text='社保缴纳地', max_length=10, null=True, verbose_name='社保缴纳地')),
                ('contract_expire', models.CharField(blank=True, help_text='合同到期', max_length=10, null=True, verbose_name='合同到期')),
                ('certificate_name', models.CharField(blank=True, help_text='证书名称', max_length=100, null=True, verbose_name='证书名称')),
                ('certificate_valid_date', models.CharField(blank=True, help_text='证书生效日期', max_length=10, null=True, verbose_name='证书生效日期')),
                ('certificate_expire_date', models.CharField(blank=True, help_text='证书生效日期', max_length=10, null=True, verbose_name='证书生效日期')),
                ('verify_url', models.CharField(blank=True, help_text='验真网址', max_length=255, null=True, verbose_name='验真网址')),
                ('grade', models.CharField(default='初级', help_text='等级', max_length=5, verbose_name='等级')),
                ('certification_body', models.CharField(blank=True, help_text='认证机构', max_length=50, null=True, verbose_name='认证机构')),
                ('creator', models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
            ],
            options={
                'verbose_name': '员工表',
                'verbose_name_plural': '员工表',
                'db_table': 'dvadmin_system_employee',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
